...
public class kakaoService implements IKakaoService{
	...
	private final String RESTAPI_KEY = ""; // RESTAPI_KEY 키
	//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	//---------------------------------------------------------------로그인 후 사용자 인증코드 발급을 위한 코드----------------------------------------------------------------
	@Override
	public String getAuthcode() throws Exception {
		// 카카오 SAMPLE Request 예제 참고 ///oauth/authorize?client_id={REST_API_KEY}&redirect_uri={REDIRECT_URI}&response_type=code
